...
export function LoginPage() {
    ...
    const fieldsToShow = LoginPageDetails.filter(detail => {
        if (pageState === "Login") {
            return (detail.label !== "UserName" && detail.label !== "Role" && detail.label !== "contactNumber")
        }
        return true
    })
    ...
    return (
        <div className="Login-page-bg" style={{ height: pageState === "SignUp" ? "520px" : "360px" }}>
                        ...
                        <>
                            ...
                            {detail.label === 'Role' && pageState === "SignUp" ? (
                                ...
                                <input
                                    ...
                                    key={index}
                                    value={formData[detail.label.toLocaleLowerCase() as keyof typeof formData]}
                                    onChange={(e) =>
                                        setFormData((prev) => ({
                                            ...prev,
